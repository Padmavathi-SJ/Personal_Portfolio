...
import { FaEnvelope, FaPhone, FaMapMarkerAlt, FaLinkedin, FaGithub } from "react-icons/fa"; // Icons

const ProfilePanel = ({ isOpen, onClose }) => {
  return (
    <div
      className={`fixed top-0 left-0 h-screen w-1/3 bg-[var(--primary-bg)] text-white shadow-lg border-r border-gray-600 transition-transform duration-500 ${
    ...
    >
      ...
      <button 
        onClick={onClose} 
        className="absolute top-6 right-6 text-white text-2xl cursor-pointer bg-gray-700 rounded-full w-8 h-8 flex items-center justify-center hover:bg-red-500 transition"
      >
        ✕
      </button>
